...
const ConnectedManualEditor = ({ photo, show, selectGardenPhoto }) => show ? (

    <section className="edit-box">

        <label className="item">
            Brightness
  <input type="range" max="200" value={photo.edit.brightness} onChange={(event) => {
        ...
        <label className="item">
            Contrast
  <input type="range" max="200" value={photo.edit.contrast} onChange={(event) => {
                const photoCopy = photo;
        ...
        <label className="item">
            Saturation
  <input type="range" max="200" value={photo.edit.saturate} onChange={(event) => {
                const photoCopy = photo;
        ...
        <label className="item">
            Grayscale
  <input type="range" max="200" value={photo.edit.grayscale} onChange={(event) => {
                const photoCopy = photo;
        ...
        <label className="item">
            Sepia
  <input type="range" max="200" value={photo.edit.sepia} onChange={(event) => {
                const photoCopy = photo;
        ...
        <label className="item">
            Hue
  <input type="range" max="200" value={photo.edit.hueRotate} onChange={(event) => {
                const photoCopy = photo;
        ...
        <label className="item">
            Invert
  <input type="range" max="200" value={photo.edit.invert} onChange={(event) => {
                const photoCopy = photo;
        ...
        <label className="item">
            Blur
  <input type="range" max="200" value={photo.edit.blur} onChange={(event) => {
                const photoCopy = photo;
